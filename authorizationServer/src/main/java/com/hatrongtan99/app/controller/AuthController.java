...
public class AuthController {
    ...
    public ResponseEntity<ResponseObject<UserDetailAuthResponseDto>> authenticate(@AuthenticationPrincipal() Authentication principal) throws Exception {
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        return ResponseEntity.ok(new ResponseObject<>(true, "success", userService.authenticated(null)));
    }
