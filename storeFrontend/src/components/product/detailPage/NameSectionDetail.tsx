    ...
    return (
        <div className="">
            ...
            <div className="flex items-center my-3">
                ...
                <span className="underline-offset-4 underline mr-2 text-base font-medium">0</span>
                ...
                <p className="text-base font-medium underline underline-offset-4">
                    {3}
                    <Link href={"#"} className="text-sm no-underline inline-block text-secondary-color cursor-pointer">&nbsp;đánh giá</Link>
                </p>
                ...
                <p className="text-base font-medium underline underline-offset-4">
                    {3}
                    <span className="text-sm no-underline text-text-light-color inline-block">&nbsp;đã bán</span>
                </p>
            </div>
        </div>
    )
